...
std::unordered_map<uint8_t, std::string> ShaderList::COMP_SHADER_SOURCE {
		...
		{RendEnum::RENDER_GPU_PATTERN, "Assets/Shaders/Compute/PointCloud/renderGPUPattern"},
		...
		{RendEnum::STORE_GPU_PATTERN, "Assets/Shaders/Compute/PointCloud/storeGPUPattern"},
