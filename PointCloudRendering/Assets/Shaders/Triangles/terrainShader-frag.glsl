...
// ----------- Materials ------------
uniform sampler2D texGrassSampler;
...
{
	vec4 grassColor = texture(texGrassSampler, textCoord * grassTextureScale);
	...
	return vec4(mix(grassColor.rgb, rockColor.rgb, rockWeight), grassColor.w);
}
